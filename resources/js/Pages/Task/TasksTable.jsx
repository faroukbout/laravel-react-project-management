...
export default function TasksTable({tasks,queryParams=null, showProjectName=true}) {
  ...
  return (
    ...
    <thead className='text-xs  uppercase bg-gray-100  border-b-2'>
        <tr className='text-nowrap'>
            ...
            {showProjectName && (<th className='px-3 py-3 text-gray-700'>Project name</th>)}
            <TableHeader 
                name="name"
    ...
    <thead className='text-xs  uppercase bg-gray-100  border-b-2'>
        <tr className='text-nowrap'>
            ...
            <th className='px-3 py-3 text-gray-700'></th>
            {showProjectName && (<th className='px-3 py-3 text-gray-700'></th>)}
    ...
    <tbody className='bg-white'>
        {tasks.data.map((task) => (
            <tr className='hover:bg-gray-50 transition ' key={task.id}>
                ...
                {showProjectName && (<td className='px-3 py-3 text-gray-800'>{task.project.name}</td>) }
